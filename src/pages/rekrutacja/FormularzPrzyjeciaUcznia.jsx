...
const initialData = {
  ...
  optionalSubjects: [], pe: 'uczestniczy', athlete: 'nie', sport: '', achievements: '', independentTravel: '',
...
const sampleData = {
  ...
  language1: 'Język angielski', language1Level: 'kontynuacja', language2: 'Język niemiecki', language2Level: 'podstawowy', subjects: ['Biologia', 'Chemia'], optionalSubjects: ['Etyka'], athlete: 'tak', sport: 'pływanie', opinion: 'nie', independentTravel: 'tak',
};
...
export default function FormularzPrzyjeciaUcznia() {
  ...
  return <section className="admission-page container">
    ...
    <form ref={formRef} onSubmit={submit} onInvalid={setRequiredValidationMessage} onInput={clearValidationMessage} className="admission-form">
